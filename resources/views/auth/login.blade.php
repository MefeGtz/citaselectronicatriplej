...
<div class="container mt--8 pb-5">
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form role="form" method="POST" action="{{route('login')}}">
                ...
                <div class="text-center">
                  <button type="submit" class="btn btn-primary my-4"> <i class="fas fa-sign-in-alt"></i> Iniciar</button>
                </div>
              </form>
            </div>
          </div>
          <div class="row mt-3">
            <div class="col-6">
              <a href="{{ route('password.request') }}" class="text-light"><small>¿Olvido la contraseña?</small></a>
            </div>
          </div>
        </div>
      </div>
